...
class BoltSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $collection_2 = DB::table('collections')
            ->insertGetId([
        ...
        $section1_field_1 = DB::table('fields')
            ->insertGetId([
        ...
        $section1_field_2 = DB::table('fields')
            ->insertGetId([
        ...
        $section2_field_1 = DB::table('fields')
            ->insertGetId([
                'name' => json_encode(['en' => 'rate your experience', 'ar' => 'تقييم تجربتك معنا'],
                    JSON_THROW_ON_ERROR),
                'section_id' => $section2,
                'ordering' => 1,
                'options' => json_encode([
        ...
        $section2_field_2 = DB::table('fields')
            ->insertGetId([
                'name' => json_encode([
